...
<div id="memberSave" style="
    ...
    <form action="/update" method="post" name="updateForm" enctype="multipart/form-data">
        <div id="mainLogin">
            ...
            <input type="text" name="memberNickName" value="${member.memberNickName}" placeholder="닉네임을 입력하세요"> <br>
            <input type="text" name="memberEmail" value="${member.memberEmail}" readonly placeholder="이메일"> <br>
            <input type="text" name="memberPassword" id="memberPassword" placeholder="비밀번호를 입력하세요"> <br>
            <input type="text" name="memberName" value="${member.memberName}" readonly placeholder="이름"> <br>
            <input type="text" name="memberMobile" value="${member.memberMobile}" placeholder="전화번호를 입력하세요"> <br>
            <input type="button" onclick="update_check()" value="수정하기" style="background-color: dodgerblue; color: white; border-radius: 12px; font-size: 16px;" ><br>
    </form>
</div>
</body>
<script>
